...
import { ArrowLeft, Trophy, BookOpen, Brain, Calendar, Award, LogOut, TrendingUp, Layers } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    enabled: Boolean(userId),  // ✅ userId 있을 때만 요청
    queryFn: async () => {
      const res = await axios.get(`http://52.78.157.84:8080/user/${userId}`)
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <Card>
          ...
          <CardContent>
            {result.skillStatus.map((skill: any, idx: number) => (
